...
//     !isset($_POST["negovalue"]) || $negovalue = $_POST["negovalue"] =="" ||
...
$sql =  "INSERT INTO arsenal_transfer_table(id,indate, name, birth,age, country,
position,value,comment )VALUES(NULL,sysdate(), :name, :birth,$age, :country, :position, :value, :comment)";
