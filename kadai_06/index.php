...
$stmt = $pdo->prepare("SELECT * FROM arsenal_member_table");
$status = $stmt->execute();
...
<header>
  ...
  .navbar-default{
    ...
    <div class="container-fluid">
      ...
      <div class="navbar-brand"><span>在籍メンバー</sapn></div>
      </div>
    </div>
  </nav>
</header>
  ...
  <div class="form-group">
   <fieldset style="margin:20px">
    <legend>プレーヤー登録</legend>
     <label>背番号：<input type="text" class="form-control" name="number"></label><br>
     ...
     <label>推定市場価格：<input type="text" class="form-control" name="value" ></label><br>
     <label>ポジション：
